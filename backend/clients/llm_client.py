...
class LLMClient:
    ...
    def __init__(self, model: str = "anthropic.claude-3-haiku-20240307-v1:0", region: str = "us-east-1"):
        ...
        self.region = region
        self.max_retries = 3
        # Configure boto3 with proper timeouts
    ...
    def test_connection(self) -> Tuple[bool, str]:
        ...
        try:
            # Create Bedrock Runtime client with timeout config
            self.client = boto3.client("bedrock-runtime", region_name=self.region, config=self.boto_config)
